...
namespace io::socket::ip::address::ipv6 {
    ...
    InetAddress::InetAddress(const std::string& ipOrHostname, uint16_t port) {
        ...
        int err = io::system::getaddrinfo(ipOrHostname.c_str(), nullptr, &hints, &res);
        ...
        io::system::freeaddrinfo(resalloc);
    }
    ...
    std::string InetAddress::host() const {
        ...
        io::system::getnameinfo(reinterpret_cast<const sockaddr*>(&sockAddr), sizeof(sockAddr), host, 256, nullptr, 0, 0);
    ...
    std::string InetAddress::ip() const {
        char ip[NI_MAXHOST];
        io::system::getnameinfo(reinterpret_cast<const sockaddr*>(&sockAddr), sizeof(sockAddr), ip, 256, nullptr, 0, NI_NUMERICHOST);
    ...
    std::string InetAddress::serv() const {
        ...
        io::system::getnameinfo(reinterpret_cast<const sockaddr*>(&sockAddr), sizeof(sockAddr), nullptr, 0, serv, 256, 0);
