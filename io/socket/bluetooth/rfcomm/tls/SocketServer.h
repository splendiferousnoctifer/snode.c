...
#ifndef IO_SOCKET_BLUETOOTH_RFCOMM_TLS_SOCKETSERVER_H
#define IO_SOCKET_BLUETOOTH_RFCOMM_TLS_SOCKETSERVER_H
...
#endif // IO_SOCKET_BLUETOOTH_RFCOMM_TLS_SOCKETSERVER_H
