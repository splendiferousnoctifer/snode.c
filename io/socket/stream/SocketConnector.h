                    ...
                    if (errnum > 0) {
                        ...
                        Socket::bind(bindAddress, [this, &remoteAddress, &onError](int errnum) -> void {
                            if (errnum > 0) {
                                ...
                                int ret = core::system::connect(getFd(), &remoteAddress.getSockAddr(), remoteAddress.getSockAddrLen());
            ...
            if (err == 0) {
                ...
                if (errno != EINPROGRESS) {
                    if (errno == 0) {
                        ...
                        if (core::system::getsockname(getFd(), reinterpret_cast<sockaddr*>(&localAddress), &localAddressLength) == 0 &&
                            core::system::getpeername(getFd(), reinterpret_cast<sockaddr*>(&remoteAddress), &remoteAddressLength) == 0) {
