...
#ifndef IO_EXCEPTIONALCONDITIONEVENTRECEIVER_H
#define IO_EXCEPTIONALCONDITIONEVENTRECEIVER_H
...
namespace io {
    ...
    class ExceptionalConditionEventReceiver : public core::EventReceiver {
    protected:
...
#endif // IO_EXCEPTIONALCONDITIONEVENTRECEIVER_H
